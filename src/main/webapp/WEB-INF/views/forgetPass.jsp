		...
		<div class="content-wrapper">
			...
			<div
				...
				<div class="loginInner">
						...
						<form action="getUserInfoByMobNo" method="post" id="mob_form">
						...
						<div class="clr"></div>
							...
							<div
										...
										<input type="text" class="form-control  logn_input text-white"
											placeholder="Enter Registered Mobile No." maxlength="10" id="mob" name="mob">
										<div class="form-control-feedback">
											<i class="icon-mail5  text-white"></i>
										</div>
										<span class="error_form" id="error_mob"
								style="display: none; color: #fff;">Enter Registered Mobile No.</span>
									</div>
