			 ...
			 <div
				...
				<div class="loginInner">
						...
						<%
								...
								%>
								 <h3 style="text-align: center;"> <% out.println(session.getAttribute("successMsg")); %></h3>
								<%
						...
						<div
											...
											<input type="text" class="form-control logn_input text-white"
												placeholder="Username" maxlength="10" id="username" name="username">
										...
										<div
											...
											<input id="password-field" type="password" name="password"
												class="form-control logn_input text-white" name="password" placeholder="Password"
