			...
			<div class="content">
				...
				<div class="card">
					...
					<div
						...
						<span
							...
							href="${pageContext.request.contextPath}/configRelatedProduct"
							style="color: white;">Add Configuration</a></span>
					</div>
				...
				<jsp:include page="/WEB-INF/views/include/response_msg.jsp"></jsp:include>
					...
					<table class="table datatable-header-basic">
						...
						<tbody>
							<c:forEach items="${relatedProductList}" var="list" varStatus="count">
								 <tr>
									<td>${count.index+1}</td>
									<td>${list.productName}</td>
									<td>${list.relatedProduct}</td>
									<td style="display: none;"></td>		
									<td style="display: none;"></td>		
									<td class="text-center">
										<div class="list-icons">
											<a href="${pageContext.request.contextPath}/editRelatedProduct?relatedProductId=${list.exVar2}"
				...
				function() {
					var uuid = $(this).data("uuid") // will return the number 123
								...
								callback : function(result) {
									if (result) {
										location.href = "${pageContext.request.contextPath}/deleteRelatedProduct?relatedProductId="
												+ uuid;
