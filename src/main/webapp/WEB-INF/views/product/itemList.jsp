						...
						<div class="card">
							<div
								...
								<span class="font-size-sm text-uppercase font-weight-semibold"><h6
									...
									style="color: white;" class="card-title">Add Item & SKU Configuration</a></span>
							</div>
							<br>
						...
						<tbody>
							<c:forEach items="${itemList}" var="itemList" varStatus="count">
								 <tr>
									...
									<td>${itemList.cntSkuId}</td>
									<td style="display: none;"></td>							
									<td class="text-center">										
										<div class="list-icons">
											<a href="${pageContext.request.contextPath}/editItem?itemId=${itemList.itemId}"
										...
										<a href="javascript:void(0)"
													...
													data-uuid="${itemList.itemId}" data-popup="tooltip"
