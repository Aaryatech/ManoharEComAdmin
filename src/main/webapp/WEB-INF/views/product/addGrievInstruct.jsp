						...
						<div class="card">
							...
							<div
								...
								<span class="font-size-sm text-uppercase font-weight-semibold"><a 
									...
									style="color: white;" class="card-title">Grievances Type Instruction List</a></span>
							</div>
										...
										<div class="col-lg-4">
											<div class="form-check form-check-inline">
												<label class="form-check-label"> <input type="radio"
													...
													id="grievance_y" ${griev.isActive==0 ? 'checked' : ''}>
													Active
												</label>
											</div>
											...
											<div class="form-check form-check-inline">
												<label class="form-check-label"> <input type="radio"
													...
													id="grievance_n" ${griev.isActive==1 ? 'checked' : ''}>
													In-Active
												</label>
											</div>
										</div>
