				...
				<div class="card">
					...
					<div
						...
						<span class="font-size-sm text-uppercase font-weight-semibold"><a class="card-title"
							...
							style="color: white;">Add Tag</a></span>
					</div>
					...
					<table class="table datatable-header-basic">
						...
						<tbody>
							<c:forEach items="${tagList}" var="tagList" varStatus="count">
								<tr>
									<td>${count.index+1}</td>
									<td>${tagList.tagName}</td>
									<c:set value="" var="status" />
									<c:if test="${tagList.tagIsActive==0}">
										<c:set value="Active" var="status" />
									</c:if>
									<c:if test="${tagList.tagIsActive==1}">
									...
									<td class="text-center">
										<div class="list-icons">
											<a
												href="${pageContext.request.contextPath}/editTag?tagId=${tagList.exVar1}"
										...
										<div class="list-icons">
											<a href="javascript:void(0)"
												...
												data-uuid="${tagList.exVar1}" data-popup="tooltip" title=""
												data-original-title="Delete"><i class="icon-trash"></i></a>
										</div>
										<div class="list-icons">
											<a href="#" data-toggle="modal" data-target="#modal_large"
												class="list-icons-item" title="Assigned Items"> <i
												class="icon-list2 mr-2"></i>
											</a>
										</div>
									</td>
								</tr>
				...
				<div class="modal-body">
					...
					<div class="form-group row">
						<label class="col-form-label font-weight-bold col-lg-10"
							for="cust_name"><h4>Tag Name:&nbsp; &nbsp; Tag1</h4> </label>
						<!-- <div class="col-lg-4">
											<h3>Tag1</h3>
										</div> -->
					</div>
					...
					<table class="table datatable-header-basic">
						...
						<tbody>
							...
							<tr>
								...
								<%-- <td class="text-center">
									<div class="list-icons">
										<a href="${pageContext.request.contextPath}/showTagList"
											class="list-icons-item" title="Edit"> <i
											class="icon-database-edit2"></i>
										</a>
									</div>
