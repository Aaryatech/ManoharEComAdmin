			...
			<div class="content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="card">
							<div
								...
								<span class="font-size-sm text-uppercase font-weight-semibold"><h6
									...
									href="${pageContext.request.contextPath}/addBrand"
									style="color: white;" class="card-title">Add Brand</a></span>
							</div>
							<br>
						...
						<tbody>
							<c:forEach items="${brandList}" var="brandList" varStatus="count">
								 <tr>
									<td>${count.index+1}</td>
									...
									<td class="text-center">
										<div class="list-icons">
											<a href="${pageContext.request.contextPath}/editBrand?brandId=${brandList.exVar1}"
										...
										<a href="javascript:void(0)"
													...
													data-uuid="${brandList.exVar1}" data-popup="tooltip"
					...
					function() {
						var uuid = $(this).data("uuid") // will return the number 123
									...
									callback : function(result) {
										if (result) {
											location.href = "${pageContext.request.contextPath}/deleteBrand?brandId="
													+ uuid;
