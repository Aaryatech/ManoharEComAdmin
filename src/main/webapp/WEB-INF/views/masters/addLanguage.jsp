						...
						<div class="card">
							...
							<div
								...
								<span class="font-size-sm text-uppercase font-weight-semibold"><h6
									...
									style="color: white;" class="card-title">Language List</a></span>
							</div>
							...
							<div class="card-body">
								...
								<form
									...
									<div class="form-group row">
										...
										<span
												class="validation-invalid-label" id="error_language_code"
												style="display: none;">This field is required.</span>	
										<span
												class="validation-invalid-label" id="unq_language_code"
									...
									<div class="form-group row">
										...
										<div class="col-lg-4">
											...
											<div class="form-check form-check-inline">
												<label class="form-check-label"> <input type="radio"
													class="form-check-input" value="1" name="language"
													id="language_n"
