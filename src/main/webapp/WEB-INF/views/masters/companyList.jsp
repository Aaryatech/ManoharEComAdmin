				...
				<div class="card">
					...
					<div
						...
						<h6 class="card-title">${title}</h6></span> <span
							...
							href="${pageContext.request.contextPath}/addNewCompany"
							style="color: white;">Add Company</a></span>
					</div>
						...
						<tbody>
							<c:forEach items="${compList}" var="compList" varStatus="count">
								 <tr>
									...
									<td>${compList.companyContactNo}</td>
									<td>${compList.exVar3}</td>	
									
									<c:set value="" var="status"/>
									<c:if test="${compList.isUsed==0}">
										<c:set value="Active" var="status"/>
									</c:if>
									<c:if test="${compList.isUsed==1}">
									...
									<td class="text-center">
										<div class="list-icons">
											<a href="${pageContext.request.contextPath}/editCompany?compId=${compList.exVar1}"
										...
										<a href="javascript:void(0)"
													...
													data-uuid="${compList.exVar1}" data-popup="tooltip"
				...
				function() {
					var uuid = $(this).data("uuid") // will return the number 123
								...
								callback : function(result) {
									if (result) {
										location.href = "${pageContext.request.contextPath}/deleteCompany?compId="
												+ uuid;
