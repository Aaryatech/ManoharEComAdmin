				...
				<div class="card">
					...
					<div
						...
						<h6 class="card-title">${title}</h6></span> <span
							...
							style="color: white;">Add Language</a></span>
					</div>
								 ...
								 <tr>
									...
									<td class="text-center">
										<div class="list-icons">
											<a href="${pageContext.request.contextPath}/editLang?langId=${langList.exVar1}"
										...
										<a href="javascript:void(0)"
													...
													data-uuid="${langList.exVar1}" data-popup="tooltip"
